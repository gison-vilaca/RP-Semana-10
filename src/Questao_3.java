    ...
    public void calcularTransformacaoLogaritmica() {
        ...
        for(int x=0; x<img.length; x++){
            for(int y=0; y< img[0].length; y++){
                //      S =                                   c *      log(1 + r)
                img[x][y] = (int) Math.min(255, Math.max(0, (c1 * Math.log(1 + img[x][y]))));
            }
        }
        ...
        for(int x=0; x<img.length; x++){
            for(int y=0; y< img[0].length; y++){
                //      S =                                   c *      log(1 + r)
                img[x][y] = (int) Math.min(255, Math.max(0, (c2 * Math.log(1 + img[x][y]))));
            }
        }
        ...
        for(int x=0; x<img.length; x++){
            for(int y=0; y< img[0].length; y++){
                //      S =                                   c *      log(1 + r)
                img[x][y] = (int) Math.min(255, Math.max(0, (c3 * Math.log(1 + img[x][y]))));
            }
        }
